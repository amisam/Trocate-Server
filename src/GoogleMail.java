...
/**
 * Code snippets taken from the internet.
 * Worked for one day then decided it didn't ever want to work again
 * @author doraemon
 */
public class GoogleMail {
    ...
    public static void main(String[] args){
    	try {
			Send(username, password, username+"@gmail.com", "test", "work");
